...
class EditLocationWidget extends StatefulWidget {
  const EditLocationWidget({Key key}) : super(key: key);

  @override
  _EditLocationWidgetState createState() => _EditLocationWidgetState();
}
            ...
            FFButtonWidget(
              onPressed: () async {
                final usersUpdateData = createUsersRecordData(
                  location: emailTextFieldController.text,
                );
