...
class AgriculturalProductsWidget extends StatefulWidget {
  const AgriculturalProductsWidget({Key key}) : super(key: key);

  @override
  _AgriculturalProductsWidgetState createState() =>
      _AgriculturalProductsWidgetState();
}

class _AgriculturalProductsWidgetState
    extends State<AgriculturalProductsWidget> {
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            'iza2pyv9' /* Agricultural Products */,
          ),
              ...
              child: StreamBuilder<List<PostsRecord>>(
                stream: queryPostsRecord(
                  queryBuilder: (postsRecord) => postsRecord
                      .where('post_category', isEqualTo: 'Food & Beverages'),
                ),
