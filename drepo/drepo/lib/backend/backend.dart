...
/// Functions to query QuantitiesRecords (as a Stream and as a Future).
Stream<List<QuantitiesRecord>> queryQuantitiesRecord({
...
Future<List<QuantitiesRecord>> queryQuantitiesRecordOnce({
  DocumentReference parent,
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<QuantitiesRecord>> queryQuantitiesRecordPage({
  DocumentReference parent,
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
