...
class _$PostsRecordSerializer implements StructuredSerializer<PostsRecord> {
  ...
  Iterable<Object> serialize(Serializers serializers, PostsRecord object,
    ...
    value = object.postSubcategory;
    if (value != null) {
      result
        ..add('post_subcategory')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(String)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'post_subcategory':
          result.postSubcategory = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
...
class _$PostsRecord extends PostsRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is PostsRecord &&
        ...
        postSubcategory == other.postSubcategory &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper('PostsRecord')
          ...
          ..add('postSubcategory', postSubcategory)
...
class PostsRecordBuilder implements Builder<PostsRecord, PostsRecordBuilder> {
  ...
  String get postSubcategory => _$this._postSubcategory;
  set postSubcategory(String postSubcategory) =>
      _$this._postSubcategory = postSubcategory;
  ...
  PostsRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _postSubcategory = $v.postSubcategory;
