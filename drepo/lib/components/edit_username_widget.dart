...
class EditUsernameWidget extends StatefulWidget {
  const EditUsernameWidget({Key key}) : super(key: key);

  @override
  _EditUsernameWidgetState createState() => _EditUsernameWidgetState();
}
            ...
            FFButtonWidget(
              onPressed: () async {
                final usersUpdateData = createUsersRecordData(
                  displayName: emailTextFieldController.text,
                );
