...
class HealthBeautyWidget extends StatefulWidget {
  const HealthBeautyWidget({Key key}) : super(key: key);

  @override
  _HealthBeautyWidgetState createState() => _HealthBeautyWidgetState();
}
                ...
                child: StreamBuilder<List<PostsRecord>>(
                  stream: queryPostsRecord(
                    queryBuilder: (postsRecord) => postsRecord
                        .where('post_category', isEqualTo: 'Home Appliances '),
                  ),
