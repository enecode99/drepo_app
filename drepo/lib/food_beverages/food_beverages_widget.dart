...
class FoodBeveragesWidget extends StatefulWidget {
  const FoodBeveragesWidget({Key key}) : super(key: key);

  @override
  _FoodBeveragesWidgetState createState() => _FoodBeveragesWidgetState();
}
